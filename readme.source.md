...
Support is available via a [Tidelift Subscription](https://tidelift.com/subscription/pkg/nuget-nservicebus.utf8json?utm_source=nuget-nservicebus.utf8json&utm_medium=referral&utm_campaign=enterprise).
